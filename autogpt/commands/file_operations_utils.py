...
extension_to_parser = {
    ...
    ".pdf": PDFParser(),
    ".docx": DOCXParser(),
    ".json": TXTParser(), #JSONParser(),
    ".xml": TXTParser(), #XMLParser(),
    ".yaml": YAMLParser(),
    ".yml": YAMLParser(),
    ".html": TXTParser(), #HTMLParser(),
    ".htm": TXTParser(), #HTMLParser(),
    ".xhtml": TXTParser(), #HTMLParser(),
    ".md": TXTParser(), #MarkdownParser(),
    ".markdown": TXTParser(), #MarkdownParser(),
    ".tex": LaTeXParser(),
}
