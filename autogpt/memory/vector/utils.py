from typing import Any, overload, Union, List, TypeVar
...
@overload
def get_embedding(input: Union[str, TText]) -> Embedding:
    ...


@overload
def get_embedding(input: Union[List[str], List[TText]]) -> List[Embedding]:
    ...


def get_embedding(
    input: Union[str, TText, List[str], List[TText]], config: Config
